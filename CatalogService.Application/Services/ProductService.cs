...
public class ProductService
{
    ...
    public async Task<PagedResult<Product>> GetPagedAsync(int? categoryId, int pageNumber, int pageSize)
    {
        return pageNumber <= 0
            ...
            : await _productRepository.GetPagedAsync(categoryId, pageNumber, pageSize);
    }
    ...
    {
        return id <= 0 ? throw new ArgumentException("Invalid product id", nameof(id)) : await _productRepository.GetByIdAsync(id);
    }
